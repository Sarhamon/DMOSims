...
export const summons = [
    ...
    },
    {
        ...
        pity: {
            every: 50,
            reward: { name: "슬픔과 결의의 상자", grade: "U", category: "other" },
        },
        items: [
            { probability: 0.05, name: "슬픔과 결의의 상자", grade: "U", category: "other" },
            { probability: 0.05, name: "봉인된 얼티밋 크로스로더 상자", grade: "U", category: "other" },
    ...
    },
    {
        ...
        pity: {
            every: 50,
            reward: { name: "코드 크라운 : 파이널 크로스", grade: "U", category: "other" },
        },
        items: [
            { probability: 0.05, name: "코드 크라운 : 파이널 크로스", grade: "U", category: "other" },
            { probability: 0.05, name: "봉인된 얼티밋 크로스로더 상자", grade: "U", category: "other" },
            { probability: 0.45, name: "제로 유니트 악세서리 랜덤 상자", grade: "SSS+", category: "other" },
            { probability: 0.45, name: "봉인된 디지털 해저드 악세서리 세트 상자", grade: "SSS+", category: "other" },
            { probability: 0.5, name: "놀라운 힘의 응축체[SSS+]", grade: "SSS+", category: "evolution" },
    ...
    },
    {
        ...
        pity: {
            every: 50,
            reward: { name: "초융합 : 하이브리드", grade: "U", category: "other" },
        },
        items: [
            { probability: 0.05, name: "초융합 : 하이브리드", grade: "U", category: "other" },
            { probability: 0.05, name: "봉인된 얼티밋 크로스로더 상자", grade: "U", category: "other" },
            { probability: 0.45, name: "제로 유니트 악세서리 랜덤 상자", grade: "SSS+", category: "other" },
            { probability: 0.45, name: "봉인된 디지털 해저드 악세서리 세트 상자", grade: "SSS+", category: "other" },
            { probability: 0.5, name: "놀라운 힘의 응축체[SSS+]", grade: "SSS+", category: "evolution" },
    ...
    {
        id: "neverland-special",
        name: "네버랜드의 주인",
        pity: {
            every: 50,
            reward: { name: "메타모포시스", grade: "U", category: "other" },
        },
        items: [
            { probability: 0.05, name: "메타모포시스", grade: "U", category: "other" },
            { probability: 0.05, name: "봉인된 얼티밋 크로스로더 상자", grade: "U", category: "other" },
            { probability: 0.45, name: "제로 유니트 악세서리 랜덤 상자", grade: "SSS+", category: "other" },
            { probability: 0.45, name: "봉인된 디지털 해저드 악세서리 세트 상자", grade: "SSS+", category: "other" },
            { probability: 0.5, name: "놀라운 힘의 응축체[SSS+]", grade: "SSS+", category: "evolution" },
    ...
    },
    {
        ...
        pity: {
            every: 50,
            reward: { name: "대자연의 힘", grade: "U", category: "other" },
        },
        items: [
            { probability: 0.05, name: "대자연의 힘", grade: "U", category: "other" },
            { probability: 0.05, name: "봉인된 얼티밋 크로스로더 상자", grade: "U", category: "other" },
            { probability: 0.45, name: "제로 유니트 악세서리 랜덤 상자", grade: "SSS+", category: "other" },
            { probability: 0.45, name: "봉인된 디지털 해저드 악세서리 세트 상자", grade: "SSS+", category: "other" },
            { probability: 0.5, name: "놀라운 힘의 응축체[SSS+]", grade: "SSS+", category: "evolution" },
    ...
    },
    {
        ...
        pity: {
            every: 50,
            reward: { name: "시간 파괴자", grade: "U", category: "other" },
        },
        items: [
            { probability: 0.05, name: "시간 파괴자", grade: "U", category: "other" },
            { probability: 0.05, name: "봉인된 얼티밋 크로스로더 상자", grade: "U", category: "other" },
            { probability: 0.45, name: "제로 유니트 악세서리 랜덤 상자", grade: "SSS+", category: "other" },
            { probability: 0.45, name: "봉인된 디지털 해저드 악세서리 세트 상자", grade: "SSS+", category: "other" },
            { probability: 0.5, name: "놀라운 힘의 응축체[SSS+]", grade: "SSS+", category: "evolution" },
    ...
    },
    {
        ...
        pity: {
            every: 50,
            reward: { name: "스플렌더 블레이드", grade: "U", category: "other" },
        },
        items: [
            { probability: 0.05, name: "스플렌더 블레이드", grade: "U", category: "other" },
            { probability: 0.05, name: "봉인된 얼티밋 크로스로더 상자", grade: "U", category: "other" },
            { probability: 0.45, name: "제로 유니트 악세서리 랜덤 상자", grade: "SSS+", category: "other" },
            { probability: 0.45, name: "봉인된 디지털 해저드 악세서리 세트 상자", grade: "SSS+", category: "other" },
            { probability: 0.5, name: "놀라운 힘의 응축체[SSS+]", grade: "SSS+", category: "evolution" },
    ...
    {
        id: "alphainforce-special",
        name: "궁극전인",
        pity: {
            every: 50,
            reward: { name: "알파 인포스", grade: "U", category: "other" },
        },
        items: [
            { probability: 0.05, name: "알파 인포스", grade: "U", category: "other" },
            { probability: 0.05, name: "봉인된 얼티밋 크로스로더 상자", grade: "U", category: "other" },
            { probability: 0.45, name: "제로 유니트 악세서리 랜덤 상자", grade: "SSS+", category: "other" },
            { probability: 0.45, name: "봉인된 디지털 해저드 악세서리 세트 상자", grade: "SSS+", category: "other" },
            { probability: 0.5, name: "놀라운 힘의 응축체[SSS+]", grade: "SSS+", category: "evolution" },
